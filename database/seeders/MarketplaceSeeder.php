...
class MarketplaceSeeder extends Seeder
{
    ...
    private function createSellerProfiles(Organization $organization): array
    {
        ...
        foreach ($existingUsers as $index => $user) {
            $sellers[] = SellerProfile::create([
                ...
                'bio' => 'Passionate educator sharing resources to help participants succeed.',
        ...
        $externalSellers = [
            [
                ...
                'bio' => 'Clinical psychologist and SEL curriculum developer. 20+ years working with K-12 participants on social-emotional learning and mental health.',
            ...
            [
                ...
                'expertise_areas' => ['Professional Development', 'LearningGroup Management', 'Instructional Design'],
                'credentials' => [
            ...
            [
                ...
                'bio' => 'High organization math instructor sharing differentiated resources that make algebra accessible for all participants.',
            ...
            [
                ...
                'bio' => 'Elementary organization instructor passionate about making reading fun! Creator of engaging literacy resources for K-3.',
    ...
    private function createMarketplaceItems(array $sellers, Organization $organization): array
    {
        ...
        $surveyItems = [
            [
                'title' => 'Weekly Participant Wellness Check-In',
                'short_description' => 'A quick 5-question wellness check for monitoring participant mental health.',
                'description' => "A research-validated weekly check-in survey designed to quickly assess participant wellness across five key dimensions: emotional state, stress level, sleep quality, social connections, and academic confidence.\n\n**What's Included:**\n- 5 carefully crafted questions with visual response scales\n- Automatic scoring and interpretation guide\n- Trend tracking recommendations\n- Spanish and Chinese translations\n\n**Best For:** K-12 homeroom instructors, support_persons, and wellness coordinators",
                'tags' => ['wellness', 'mental health', 'check-in', 'SEL'],
                'target_levels' => ['3-5', '6-8', '9-12'],
            ...
            [
                ...
                'description' => "A comprehensive anxiety screening instrument based on the GAD-7 and adapted for organization settings. Includes detailed interpretation guidelines and recommended interventions.\n\n**Clinical Features:**\n- Validated against clinical gold standards\n- Age-appropriate language for levels 6-12\n- Scoring rubric with cutoff thresholds\n- Direct Supervisor notification letter templates\n- Support Person intervention flowchart\n\n**Best For:** Organization support_persons, psychologists, and mental health teams",
                'tags' => ['anxiety', 'mental health', 'assessment', 'screening'],
                'target_levels' => ['6-8', '9-12'],
                'pricing_type' => MarketplaceItem::PRICING_ONE_TIME,
                'price' => 24.99,
            ],
            [
                'title' => 'LearningGroup Climate Survey Bundle',
                'short_description' => 'Complete set of surveys to assess learning_group environment and participant belonging.',
                'description' => "A comprehensive bundle of three learning_group climate surveys designed to measure participant sense of belonging, safety, and engagement.\n\n**Bundle Includes:**\n1. Participant Belonging Scale (10 questions)\n2. LearningGroup Safety Perception Survey (8 questions)\n3. Engagement & Motivation Assessment (12 questions)\n\n**Features:**\n- Pre/post comparison tools\n- Class-level aggregate reports\n- Action planning templates\n- Staff reflection guides",
                'tags' => ['learning_group climate', 'belonging', 'engagement', 'organization culture'],
                'target_levels' => ['3-5', '6-8', '9-12'],
                'pricing_type' => MarketplaceItem::PRICING_ONE_TIME,
                'price' => 39.99,
            ],
        ...
        $strategyItems = [
            [
                ...
                'short_description' => 'Everything you need to create and manage a learning_group calm down space.',
                'description' => "A comprehensive curriculum for implementing calm down corners in K-5 learning_groups.\n\n**Includes:**\n- Setup guide with material list\n- 20 calm-down strategy cards\n- Participant self-regulation log\n- Instructor introduction script\n- Direct Supervisor communication letter\n- Progress monitoring forms\n\n**Outcomes:** Participants learn to identify emotions, select coping strategies, and self-regulate independently.",
                'tags' => ['calm down', 'self-regulation', 'emotions', 'learning_group management'],
                'target_levels' => ['K-2', '3-5'],
                'pricing_type' => MarketplaceItem::PRICING_ONE_TIME,
                'price' => 34.99,
                'is_featured' => true,
            ],
            [
                ...
                'short_description' => 'Complete lesson plans and activities to develop participant growth mindset.',
                'description' => "Transform participant attitudes about learning with this engaging 6-week growth mindset curriculum.\n\n**Weekly Themes:**\n1. Introduction to Growth Mindset\n2. The Power of Yet\n3. Embracing Challenges\n4. Learning from Mistakes\n5. Effort & Persistence\n6. Celebrating Growth\n\n**Each Week Includes:**\n- 45-minute lesson plan\n- Discussion questions\n- Interactive activity\n- Reflection journal page\n- Direct Supervisor connection activity",
            ...
            [
                ...
                'short_description' => 'Evidence-based 4-session intervention for participants with test anxiety.',
                'description' => "A structured intervention program to help participants overcome test anxiety using cognitive-behavioral techniques.\n\n**4 Sessions:**\n1. Understanding Test Anxiety\n2. Relaxation & Breathing Techniques\n3. Cognitive Restructuring\n4. Test-Taking Strategies\n\n**Materials:**\n- Facilitator guide\n- Participant workbook\n- Direct Supervisor handout\n- Pre/post assessment\n- Progress tracking form",
            ...
            [
                ...
                'description' => "Help participants develop crucial executive function skills with this collection of engaging activities and tools.\n\n**Skills Addressed:**\n- Task initiation\n- Planning & prioritizing\n- Organization\n- Time management\n- Self-monitoring\n- Flexible thinking\n\n**Includes:**\n- 30 activity cards\n- Participant planning templates\n- Visual schedules\n- Self-monitoring checklists\n- Instructor implementation guide",
            ...
            [
                'title' => 'Mindfulness in the LearningGroup',
                'short_description' => 'Daily 5-minute mindfulness practices for busy learning_groups.',
                'description' => "Bring the benefits of mindfulness to your learning_group with these quick, practical activities.\n\n**Includes:**\n- 60 mindfulness scripts (2-5 minutes each)\n- Breathing exercise cards\n- Body scan audio guides\n- Movement breaks\n- Gratitude journaling prompts\n- LearningGroup poster set\n\n**Research Shows:** Regular mindfulness practice improves focus, reduces stress, and enhances emotional regulation.",
        ...
        $contentItems = [
            ...
            [
                ...
                'short_description' => 'Participant workbook with 30 anxiety management activities.',
                'description' => "A comprehensive participant workbook filled with engaging activities to help manage anxiety.\n\n**Sections:**\n1. Understanding Anxiety (psychoeducation)\n2. Body Awareness (recognizing physical symptoms)\n3. Breathing & Relaxation\n4. Thought Challenging\n5. Coping Strategies\n6. Building Confidence\n\n**Features:**\n- 30 printable activity pages\n- Journal prompts\n- Coping cards to cut out\n- Progress tracker\n- Direct Supervisor guide",
            ...
            [
                ...
                'description' => "Engage participants in practicing conflict resolution with these realistic, age-appropriate scenarios.\n\n**Includes:**\n- 25 scenario cards\n- Discussion questions for each\n- Role play guidelines\n- De-escalation strategies poster\n- Reflection worksheet\n\n**Scenario Topics:**\n- Peer disagreements\n- Group project conflicts\n- Social media issues\n- Rumors and gossip\n- Competition and jealousy",
            ...
            [
                ...
                'tags' => ['morning meeting', 'community building', 'learning_group routine', 'SEL'],
                'target_levels' => ['K-2', '3-5'],
                'pricing_type' => MarketplaceItem::PRICING_ONE_TIME,
                'price' => 24.99,
            ],
            [
                ...
                'description' => "Help participants develop healthy self-esteem with this engaging animated video series.\n\n**Videos (5-7 minutes each):**\n1. What is Self-Esteem?\n2. Your Inner Voice\n3. Positive Self-Talk\n4. Celebrating Strengths\n5. Handling Mistakes\n6. Setting Boundaries\n7. Comparison Trap\n8. Building Confidence\n9. Asking for Help\n10. Loving Yourself\n\n**Includes:**\n- Streaming access\n- Discussion guides\n- Participant reflection sheets\n- Direct Supervisor companion guide",
            ...
            [
                'title' => 'Trauma-Informed LearningGroup Strategies Guide',
                'short_description' => 'Practical strategies for creating trauma-sensitive learning environments.',
                'description' => "Essential guide for educators working with participants who have experienced trauma.\n\n**Covers:**\n- Understanding trauma and its effects\n- Creating safe learning_group environments\n- Recognizing trauma responses\n- De-escalation techniques\n- Building trusting relationships\n- Self-care for educators\n\n**Formats:**\n- 45-page PDF guide\n- Quick reference cards\n- Poster of calming strategies\n- Staff training presentation",
                'tags' => ['trauma-informed', 'learning_group management', 'safety', 'professional development'],
                'target_levels' => ['K-2', '3-5', '6-8', '9-12'],
                'pricing_type' => MarketplaceItem::PRICING_FREE,
                'is_featured' => true,
            ],
        ];
        ...
        $providerItems = [
            [
                ...
                'short_description' => 'Licensed therapists providing teletherapy for K-12 participants.',
                'description' => "Connect your participants with licensed mental health professionals through our virtual therapy platform.\n\n**Services:**\n- Individual therapy sessions\n- Group counseling\n- Crisis intervention\n- Direct Supervisor consultations\n- Instructor consultations\n\n**Features:**\n- HIPAA-compliant platform\n- Flexible scheduling\n- Progress reports to organization\n- Bilingual therapists available\n- Insurance accepted\n\n**Pricing:** Per-participant monthly subscription or per-session options available.",
            ...
            [
                ...
                'short_description' => 'One-on-one coaching for participants with executive function challenges.',
                'description' => "Personalized coaching to help participants develop crucial executive function skills.\n\n**Program Includes:**\n- Initial assessment\n- Personalized coaching plan\n- Weekly 30-minute sessions\n- Direct Supervisor/instructor check-ins\n- Progress monitoring\n- Strategy toolkit\n\n**Focus Areas:**\n- Organization\n- Time management\n- Task initiation\n- Planning & prioritizing\n- Emotional regulation",
            ...
            [
                ...
                'short_description' => 'Expert consultants to help implement SEL programs section-wide.',
                'description' => "Partner with experienced SEL consultants to successfully implement social-emotional learning across your section.\n\n**Services Include:**\n- Needs assessment\n- Curriculum selection guidance\n- Staff training workshops\n- Implementation coaching\n- Fidelity monitoring\n- Data analysis and reporting\n\n**Our Team:**\n- Former organization support_persons\n- SEL curriculum developers\n- Data analysts\n- Professional development specialists",
        ...
        foreach ($allItems as $category => $categoryItems) {
            foreach ($categoryItems as $index => $itemData) {
                ...
                $item = MarketplaceItem::create([
                    ...
                    'target_levels' => $itemData['target_levels'],
    ...
    private function createReviews(array $items, Organization $organization): void
    {
        $reviewTexts = [
            5 => [
                'Exactly what I was looking for! My participants love it.',
                'Incredible resource. Well worth the price.',
                'This has transformed my learning_group. Highly recommend!',
                'Comprehensive and easy to implement. Five stars!',
                'My participants showed immediate improvement after using this.',
                'Perfect for differentiation. Works great for all participants.',
                'The quality is outstanding. Very professional materials.',
            ],
            4 => [
                'Great resource overall. Minor improvements could be made.',
                'Very helpful for my participants. Solid purchase.',
        ...
        $sellerResponses = [
            "Thank you so much for your feedback! We're thrilled it's working well for your participants.",
    ...
    private function getRandomExpertise(): array
    {
        $options = [
            ...
            ['LearningGroup Management', 'Behavior', 'PBIS'],
