...
class MarketplaceSurveys extends Component
{
    use WithPagination;
    ...
    public function getItemsProperty()
    {
        $query = MarketplaceItem::published()
            ->inCategory(MarketplaceItem::CATEGORY_SURVEY)
        ...
        // Survey type filter (subcategories)
    ...
    public function render()
    {
        return view('livewire.marketplace.marketplace-category', [
            ...
            'categoryIcon' => 'clipboard-document-list',
            'categoryColor' => 'blue',
            'filterTypes' => $this->surveyTypes,
            'filterTypeLabel' => 'Survey Type',
        ])->layout('layouts.dashboard', ['title' => 'Marketplace - Surveys', 'hideHeader' => true]);
    }
}
