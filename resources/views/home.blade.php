        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Actionable Insights</h3>
                    <p class="text-gray-600">
                        Transform conversations into meaningful data with automated analysis and trend identification.
                    </p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                ...
                <div>
                    ...
                    <div class="text-orange-100">Conversations</div>
                </div>
                <div>
