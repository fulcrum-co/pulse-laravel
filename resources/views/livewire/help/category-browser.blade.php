<div>
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ route('help.category', $sub->slug) }}" class="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md hover:border-purple-300 transition-all">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">{{ $sub->published_articles_count }} articles</p>
                </div>
            </a>
            @endforeach
        </div>
    ...
    <section>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-8 text-center">
            ...
            <p class="mt-1 text-gray-500">Check back soon for helpful content in this category.</p>
        </div>
        @else
