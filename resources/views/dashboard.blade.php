<x-layouts.app title="Dashboard">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Welcome Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Welcome back, {{ auth()->user()->full_name ?? 'User' }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500">Surveys Completed</p>
                        <p class="text-2xl font-bold text-gray-900">0</p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-400 text-sm mt-1">Activity will appear here once students start taking surveys.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <a href="#" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div class="ml-3">
                                <p class="font-medium text-gray-900">Create Survey</p>
                                <p class="text-sm text-gray-500">Build a new student survey</p>
                            </div>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div class="ml-3">
                                <p class="font-medium text-gray-900">Add Students</p>
                                <p class="text-sm text-gray-500">Import or add students</p>
                            </div>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">Analyze survey results</p>
                            </div>
                        </a>
