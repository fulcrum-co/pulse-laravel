        ...
        <div class="p-6 space-y-6">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="mailto:{{ $provider->contact_email }}" class="inline-flex items-center px-4 py-2 bg-pulse-orange-500 text-white rounded-lg hover:bg-pulse-orange-600 transition-colors">
