...
<head>
    ...
    <title>Certificate Verification - {{ $verification['title'] ?? 'Certificate' }}</title>
...
<body class="bg-gray-50 min-h-screen">
    <div class="max-w-2xl mx-auto px-4 py-16">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-1">Verify the authenticity of this credential</p>
        </div>
            ...
            @if($verification['valid'])
                ...
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-white">Verified Certificate</h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="text-center pb-6 border-b border-gray-100">
                        <p class="text-sm text-gray-500 mb-1">Awarded to</p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">Course Hours</p>
                                <p class="font-semibold text-gray-900">{{ number_format($verification['course_hours'], 1) }} hours</p>
                            </div>
                            @endif
                        </div>
                        ...
                        <div>
                            <p class="text-sm text-gray-500">Cohort</p>
            ...
            @elseif($verification['revoked'])
                ...
                <div class="bg-gradient-to-r from-red-500 to-rose-600 px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-white">Certificate Revoked</h2>
                            <p class="text-red-100">This certificate has been revoked</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="bg-red-50 rounded-lg p-4">
                        <p class="text-sm text-red-800">
                            <strong>Revoked on:</strong> {{ $verification['revoked_at'] }}
                        </p>
                        @if($verification['revocation_reason'])
                        <p class="text-sm text-red-700 mt-2">
                            <strong>Reason:</strong> {{ $verification['revocation_reason'] }}
                        </p>
                        @endif
                    </div>
                </div>
            ...
            @else
                ...
                <div class="bg-gradient-to-r from-gray-500 to-gray-600 px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-white">Certificate Not Found</h2>
                            <p class="text-gray-200">We could not verify this certificate</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <p class="text-gray-600">
                        The certificate ID provided could not be found in our system.
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            <p>Verification performed on {{ now()->format('F j, Y \a\t g:i A') }}</p>
        </div>
    </div>
</body>
</html>
