    ...
    public function run(): void
    {
        ...
        $programs = [
            [
                ...
                'eligibility_criteria' => ['Ages 14-18', 'Direct Supervisor/guardian consent required'],
            ...
            [
                ...
                'description' => 'AVID (Advancement Via Individual Determination) is a college readiness program designed to help participants develop critical thinking, literacy, and math skills.',
                ...
                'eligibility_criteria' => ['GPA 2.5-3.5', 'Instructor recommendation', 'College aspirations'],
                'cost_structure' => Program::COST_FREE,
                'duration_weeks' => 36,
            ...
            [
                ...
                'description' => 'A peer support group for teens who have experienced the loss of a loved one. Facilitated by licensed support_persons in a safe, supportive environment.',
                ...
                'eligibility_criteria' => ['Ages 13-18', 'Experienced recent loss', 'Direct Supervisor consent'],
                'cost_structure' => Program::COST_FREE,
                'duration_weeks' => 8,
                'location_type' => Program::LOCATION_HYBRID,
            ...
            [
                ...
                'eligibility_criteria' => ['All level levels', 'Diagnostic assessment required'],
            ...
            [
                ...
                'eligibility_criteria' => ['Ages 13-17', 'Referral from therapist or organization support_person', 'Insurance or sliding scale'],
            ...
            [
                ...
                'eligibility_criteria' => ['Ages 6-18', 'Direct Supervisor/guardian involvement', 'Waitlist may apply'],
                'cost_structure' => Program::COST_FREE,
                'duration_weeks' => 52,
                'location_type' => Program::LOCATION_IN_PERSON,
            ...
            [
                ...
                'eligibility_criteria' => ['Rising 9th-12th graders', 'Application and essay', 'Instructor recommendation'],
            ...
            [
                ...
                'eligibility_criteria' => ['Organization enrollment required', 'Direct Supervisor consent for intensive track'],
                'cost_structure' => Program::COST_FREE,
                'duration_weeks' => 10,
                'location_type' => Program::LOCATION_IN_PERSON,
            ...
            [
                ...
                'description' => 'Self-paced online course teaching cognitive-behavioral techniques for managing anxiety, with weekly check-ins from a licensed support_person.',
                'program_type' => Program::TYPE_THERAPY,
            ...
            [
                ...
                'description' => 'Summer internship program placing participants in local businesses for hands-on career exploration and professional skill development.',
