<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500">Track key checkpoints and deadlines</p>
        </div>
    ...
    @if($showAddForm)
        <div class="mb-6 bg-white rounded-lg border border-gray-200 p-4">
            <h4 class="font-medium text-gray-900 mb-3">New Milestone</h4>
            <div class="space-y-3">
                <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1">Link to Goal</label>
    ...
    @if($milestones->isEmpty())
        <div class="text-center py-12 bg-white rounded-lg border border-gray-200">
            ...
            <p class="text-gray-400 text-sm mt-1">Add milestones to track key checkpoints.</p>
        </div>
    @else
        {{-- Overdue Section --}}
