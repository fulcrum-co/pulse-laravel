...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('strategic_plans', function (Blueprint $table) {
            ...
            $table->string('plan_type')->default('organizational'); // organizational, instructor, participant, department, level
            $table->string('target_type')->nullable(); // For improvement plans: App\Models\User, App\Models\Participant, App\Models\Department
