...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('mini_course_enrollments')) {
            return;
        }
        ...
        Schema::create('mini_course_enrollments', function (Blueprint $table) {
            ...
            $table->json('feedback')->nullable(); // Participant feedback collection
            ...
            $table->unique(['mini_course_id', 'participant_id']); // One enrollment per participant per course
        });
    }
