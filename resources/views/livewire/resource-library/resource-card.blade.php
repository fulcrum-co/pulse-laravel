...
@if($viewMode === 'grid')
<a href="{{ route('resources.show', $resource) }}" class="block bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md hover:border-gray-300 transition-all group">
    <div class="p-4">
        <div class="flex items-start justify-between gap-2 mb-3">
            <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0 group-hover:bg-{{ $color }}-50 transition-colors">
        ...
        <h3 class="font-medium text-gray-900 text-sm truncate mb-1 group-hover:text-pulse-orange-600 transition-colors">{{ $resource->title }}</h3>
...
@else
<a href="{{ route('resources.show', $resource) }}" class="block bg-white rounded-lg border border-gray-200 p-3 hover:shadow-sm hover:border-gray-300 transition-all group">
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2">
                <h3 class="font-medium text-gray-900 text-sm truncate group-hover:text-pulse-orange-600 transition-colors">{{ $resource->title }}</h3>
        ...
        <span class="ml-2 px-3 py-1 text-xs font-medium text-pulse-orange-600 group-hover:text-pulse-orange-700">
            View →
        </span>
    </div>
</a>
