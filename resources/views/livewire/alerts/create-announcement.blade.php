                    ...
                    <form wire:submit="send">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-medium text-gray-900">Create Announcement</h3>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-xs text-gray-500 mt-1">High/Urgent will also send email notifications.</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    <label class="flex items-center">
                                        ...
                                        <span class="ml-2 text-sm text-gray-700">All users in organization</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" wire:model.live="targetType" value="role" class="text-pulse-orange-500 focus:ring-pulse-orange-500" />
                                        <span class="ml-2 text-sm text-gray-700">Specific roles</span>
                                    </label>
                                    <label class="flex items-center">
