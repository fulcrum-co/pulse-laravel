        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-2">Sign in to your Pulse account</p>
                </div>
                ...
                <form method="POST" action="/login" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="w-4 h-4 text-pulse-600 border-gray-300 rounded focus:ring-pulse-500">
                            <span class="ml-2 text-sm text-gray-600">Remember me</span>
                        </label>
                        <a href="/forgot-password" class="text-sm text-pulse-600 hover:text-pulse-700">Forgot password?</a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="/register" class="text-pulse-600 hover:text-pulse-700 font-medium">Sign up</a>
                    </p>
                </div>
            </div>
        </div>
